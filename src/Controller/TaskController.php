...
class TaskController extends AbstractController
{
    ...
    //fonction qui ajoute une tache en BDD depuis un json
    #[Route('/task/add', name: 'app_task_add')]
    public function addtask(taskRepository $repo,
    EntityManagerInterface $manager, Request $request,SerializerInterface $serializer
    ): Response
    {
        //récupérer le json avec Request
        $json = $request->getContent();
    ...
    #[Route('/task/all', name: 'app_tasks_all')]
    //Fonction qui retourne la liste des taches au format JSON
    public function allTask(TaskRepository $repo):Response
    {   
        $tasks = $repo->findAll();
